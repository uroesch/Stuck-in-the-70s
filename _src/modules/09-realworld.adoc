...
Splitting field separated data into variables is usually down with `awk` in shell
scripts. And `awk` is superb tools when working on large data sets. However simply
splitting into shell variables is a performance killer! 
